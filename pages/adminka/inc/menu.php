...
<b><i class="fa fa-bars ml-1" style="margin-right: 5px;width: 20px;text-align: right;"></i> Админ-панель</b>
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/contest_ref"><i class="fa fa-gift"></i> Реф конкурс</a></li>
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/youtube"><i class="fa fa-plus"></i> Youtube баунти</a></li>
		...
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/pays"><i class="fa fa-money-bill"></i> Проверка выплат</a></li>
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/pays_payeer"><i class="fa fa-money-bill"></i> Проверка выплат (payeer)</a></li>
		...
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/uips"><i class="fa fa-users"></i> Поиск по IP</a></li>
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/referers"><i class="fa fa-map"></i> Источники</a></li>
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/fake"><i class="fa fa-android"></i> Фейкомёт</a></li>
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/geo"><i class="fa fa-map"></i> Проверка по IP</a></li>
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/restart"><i class="fa fa-android"></i> Рестарт</a></li>
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/config"><i class="fa fa-gear"></i> Настройки</a></li>
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/paysystem"><i class="fa fa-gear"></i> Настройки PS</a></li>
	</ul>
</div>
